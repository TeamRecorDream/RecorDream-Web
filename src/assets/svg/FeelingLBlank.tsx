...
const SvgFeelingLBlank = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 128 128" {...props}>
    <g clipPath="url(#feeling_L_blank_svg__a)">
      <path
        fill="#fff"
      ...
      />
      <g filter="url(#feeling_L_blank_svg__b)">
        <circle cx={62.476} cy={65.025} r={20.655} fill="#fff" />
      </g>
    </g>
    <defs>
      <clipPath id="feeling_L_blank_svg__a">
        <path fill="#fff" d="M0 0h128v128H0z" />
      </clipPath>
      <filter
        id="feeling_L_blank_svg__b"
        width={134.319}
        height={134.32}
        x={-4.684}
        y={-2.135}
